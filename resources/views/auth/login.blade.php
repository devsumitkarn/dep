...
-->
 ...
 <!-- Mirrored from midone-html.vercel.app/rubick-side-menu-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Aug 2025 07:34:28 GMT -->
 <!-- Added by HTTrack -->
 ...
 <head>
     ...
     <!-- BEGIN: CSS Assets-->
     <!-- END: CSS Assets-->
     <link rel="stylesheet" href="{{ url('e-sim/dist/css/app.css') }}">
 </head>
 <!-- END: Head -->
 ...
 <body>
                 ...
                 <div class="block grid-cols-2 gap-4 xl:grid">
                     ...
                     <div class="hidden min-h-screen flex-col xl:flex">
                         <a class="flex items-center pt-10" href="#">
                             <img class="w-6" src="{{ url('e-sim/dist/images/logo.svg') }}"
                         ...
                         <div class="my-auto">
                             <img class="-mt-16 w-1/2" src="{{ url('e-sim/dist/images/illustration.svg') }}"
                                 alt="Midone - Tailwind Admin Dashboard Template">
                         ...
                         <div
                             ...
                             <form method="POST" action="{{ route('login') }}">
                                 ...
                                 <div class="mt-8 flex flex-col gap-5">
                                     {{-- Email --}}
                                     <input
                                         class="h-10 w-full rounded-md border bg-background ring-offset-background
                                            file:border-0 file:bg-transparent file:font-medium file:text-foreground
                                            placeholder:text-foreground/70 focus-visible:outline-none
                                            focus-visible:ring-2 focus-visible:ring-foreground/5
                                            focus-visible:ring-offset-2 disabled:cursor-not-allowed
                                            disabled:opacity-50 block min-w-full px-5 py-6 xl:min-w-[28rem]"
                                     ...
                                     <div class="flex text-xs sm:text-sm items-center">
                                         <div class="flex gap-2.5 mr-auto flex-row items-center">
                                             <div
                                                 class="bg-background border-foreground/70 relative size-4 rounded-sm border">
                                                 <input class="peer relative z-10 size-full cursor-pointer opacity-0"
                                             ...
                                             <label class="font-medium leading-none opacity-70" for="remember-me">
                                                 Remember me
                                             </label>
                                         </div>

                                         <a class="opacity-70 hover:underline" href="#">
                                             Forgot Password?
                                         </a>
                                     </div>
                                 </div>
                                 ...
                                 <div class="mt-5 text-center xl:mt-10 xl:text-left">
                                     <button type="submit"
                                         class="cursor-pointer inline-flex border items-center justify-center gap-2 whitespace-nowrap
                                            rounded-lg text-sm font-medium ring-offset-background transition-colors
                                            focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring
                                            focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50
                                            [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0
                                            bg-(--color)/20 border-(--color)/60 text-(--color) hover:bg-(--color)/5
                                            [--color:var(--color-primary)] h-10 w-full px-4 py-5">
                                         Login
                                     </button>

                                     <a href="{{ route('register') }}"
                                         class="[--color:var(--color-foreground)] cursor-pointer inline-flex border items-center justify-center gap-2
                                        whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-colors
                                        focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring
                                        focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50
                                        [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0
                                        text-(--color) hover:bg-(--color)/5 bg-background border-(--color)/20
                                        h-10 mt-4 w-full px-4 py-5">
                                         Register
                                     </a>
                                 </div>
                             </form>
     ...
     <script src="{{ url('e-sim/dist/js/pages/login.js') }}"></script>
 ...
 <!-- Mirrored from midone-html.vercel.app/rubick-side-menu-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Aug 2025 07:34:30 GMT -->
